...
from ...common.course_index import iter_activities
from ...common.course_schema import CourseActivity, CourseArchive
...
from ..schema import AssessmentCandidate, SourceReference
