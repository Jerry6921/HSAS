...
from hsas.domain.courses.change_queue import ChangeCheckpoint
from hsas.domain.courses.change_detection import CourseChangeSet
from hsas.infrastructure.storage.json_store import read_json, write_model
