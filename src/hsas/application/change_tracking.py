...
from hsas.application.ports.repositories import ChangeQueueRepository
from hsas.domain.courses import ArchiveIndex, iter_files
from hsas.domain.courses.models import StoredFile
from hsas.domain.courses.change_queue import (
    ChangeCheckpoint,
    ChangeReference,
...
from hsas.domain.courses.change_detection import CourseChange, CourseChangeSet
