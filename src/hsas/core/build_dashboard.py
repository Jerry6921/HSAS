...
from hsas.core.manage_records import is_user_created_item, matching_archive
...
from hsas.infrastructure.sis_course_info import course_identity, sis_course_info_status
