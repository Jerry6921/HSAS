...
from hku_moodle_collector.transformation.archive_index import (
    ArchiveIndex,
    ArchiveIndexError,
    find_document_by_role,
    iter_activities,
    iter_files,
)
from hku_moodle_collector.transformation.archive_stats import refresh_archive_stats
from hku_moodle_collector.transformation.models import StoredFile
...
def test_archive_index_and_stats_are_shared_services(tmp_path: Path) -> None:
    ...
    assert find_document_by_role(archive, role="syllabus").filename == "syllabus.pdf"
